...
ASP.NET Core приложение для интеграции с системой Track&Trace API - системой отслеживания маркированных товаров в одной и стран ближнего зарубежья. Проект демонстрирует опыт системной аналитики, работы с интеграциями, базами данных и API.
